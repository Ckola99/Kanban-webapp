...
const Card = ({ taskId }) => {
	...
	return (
		<>
			<div
				className="bg-white dark:bg-secondary-black dark:text-white w-[280px] h-auto rounded-lg p-4 shadow-md hover:text-primary-blue hover:cursor-grab active:cursor-grabbing dark:hover:text-primary-blue"
				ref={setNodeRef}
				{...listeners}
				{...attributes}
				style={style}
