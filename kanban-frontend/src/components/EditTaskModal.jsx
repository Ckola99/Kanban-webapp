...
const EditTaskModal = ({ taskCard, closeEditTaskModal }) => {
	...
	const onSubmit = (data) => {
  	...
  	return (
		...
		>
			<div
				    className="bg-white dark:bg-secondary-black p-4 rounded-lg w-full max-w-[480px] max-h-[80%] overflow-scroll overflow-x-hidden scrollbar-thin scrollbar-webkit md:no-scrollbar md:max-h-screen"
