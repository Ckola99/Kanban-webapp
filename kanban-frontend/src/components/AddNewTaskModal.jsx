			...
			<div className="bg-white dark:bg-secondary-black p-4 rounded-lg w-full max-w-[480px]" onClick={(e) => e.stopPropagation()} >
				...
				>
					...
					<div className="flex flex-col gap-1 ">
						...
						<select
							className="font-bold dark:text-white text-xs border dark:border-secondary-gray px-3 py-2 rounded-md appearance-none bg-[url('./assets/icon-chevron-down.svg')] bg-no-repeat bg-[center_right_12px] dark:bg-inherit hover:cursor-pointer"
							{...register("status")}
					...
					{/* Buttons */}
						...
						<button
							className="font-bold text-white text-[13px] dark:bg-primary-blue flex-center p-2 rounded-full bg-primary-blue hover:cursor-pointer "
							type="submit"
						>
							Create Task
						</button>
